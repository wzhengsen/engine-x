...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::TransitionProgressInOut,cocos2d::TransitionProgress,cocos2d::TransitionScene,cocos2d::Scene,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("TransitionProgressInOut",false);
ns["TransitionProgressInOut"] = mt;
lua["TransitionProgressInOut"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::TransitionProgressOutIn,cocos2d::TransitionProgress,cocos2d::TransitionScene,cocos2d::Scene,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("TransitionProgressOutIn",false);
ns["TransitionProgressOutIn"] = mt;
lua["TransitionProgressOutIn"] = sol::nil;
...
void RegisterLuaCoreCameraTypeAuto(cocos2d::Lua& lua) {
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::Camera,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("Camera",false);
ns["Camera"] = mt;
lua["Camera"] = sol::nil;
...
void RegisterLuaCoreCameraBackgroundBrushBrushTypeAuto(cocos2d::Lua& lua) {
sol::table pTable = lua["cc"];
pTable = pTable["CameraBackgroundBrush"];
pTable.new_enum("BrushType"
,"NONE",0
,"DEPTH",1
,"COLOR",2
,"SKYBOX",3
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::CameraBackgroundBrush,cocos2d::Ref,cocos2d::LuaObject>("CameraBackgroundBrush",true);
ns["CameraBackgroundBrush"] = mt;
lua["CameraBackgroundBrush"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::CameraBackgroundDepthBrush,cocos2d::CameraBackgroundBrush,cocos2d::Ref,cocos2d::LuaObject>("CameraBackgroundDepthBrush",false);
ns["CameraBackgroundDepthBrush"] = mt;
lua["CameraBackgroundDepthBrush"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::CameraBackgroundColorBrush,cocos2d::CameraBackgroundDepthBrush,cocos2d::CameraBackgroundBrush,cocos2d::Ref,cocos2d::LuaObject>("CameraBackgroundColorBrush",false);
ns["CameraBackgroundColorBrush"] = mt;
lua["CameraBackgroundColorBrush"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::CameraBackgroundSkyBoxBrush,cocos2d::CameraBackgroundBrush,cocos2d::Ref,cocos2d::LuaObject>("CameraBackgroundSkyBoxBrush",false);
ns["CameraBackgroundSkyBoxBrush"] = mt;
lua["CameraBackgroundSkyBoxBrush"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::GridBase,cocos2d::Ref,cocos2d::LuaObject>("GridBase",true);
ns["GridBase"] = mt;
lua["GridBase"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::BaseLight,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("BaseLight",true);
ns["BaseLight"] = mt;
lua["BaseLight"] = sol::nil;
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::DirectionLight,cocos2d::BaseLight,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("DirectionLight",false);
ns["DirectionLight"] = mt;
lua["DirectionLight"] = sol::nil;
