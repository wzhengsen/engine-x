...
mt.set_function("new",static_cast<cocos2d::BezierBy*(*)(float,const cocos2d::ccBezierConfig&)>(&cocos2d::BezierBy::create));
}
...
mt.set_function("new",static_cast<cocos2d::BezierTo*(*)(float,const cocos2d::ccBezierConfig&)>(&cocos2d::BezierTo::create));
}
