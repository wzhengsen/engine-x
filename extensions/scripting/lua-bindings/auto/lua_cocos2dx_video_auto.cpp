...
void lua_register_cocos2dx_video_VideoPlayer(cocos2d::Lua& lua){
...
mt["create"]=static_cast<cocos2d::ui::VideoPlayer*(*)()>(&cocos2d::ui::VideoPlayer::create);
}
void register_all_cocos2dx_video(cocos2d::Lua& lua) {
	lua_register_cocos2dx_video_VideoPlayer(lua);
}
