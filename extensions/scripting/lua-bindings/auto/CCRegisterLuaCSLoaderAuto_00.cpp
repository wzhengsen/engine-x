...
mt.set_function("CreateNode",sol::overload(static_cast<cocos2d::Node*(*)(const std::string&,const cocos2d::ccNodeLoadCallback&)>(&cocos2d::CSLoader::createNode),static_cast<cocos2d::Node*(*)(const std::string&)>(&cocos2d::CSLoader::createNode),static_cast<cocos2d::Node*(*)(const std::string&,const cocos2d::Size&)>(&cocos2d::CSLoader::createNode),static_cast<cocos2d::Node*(*)(const std::string&,const cocos2d::Size&,const cocos2d::ccNodeLoadCallback&)>(&cocos2d::CSLoader::createNode),static_cast<cocos2d::Node*(*)(const cocos2d::Data&)>(&cocos2d::CSLoader::createNode),static_cast<cocos2d::Node*(*)(const cocos2d::Data&,const cocos2d::ccNodeLoadCallback&)>(&cocos2d::CSLoader::createNode)));
