...
mt.set_function("new",static_cast<cocostudio::FrameData*(*)()>(&cocostudio::FrameData::create));
}
...
mt.set_function("new",static_cast<cocostudio::MovementBoneData*(*)()>(&cocostudio::MovementBoneData::create));
}
...
mt.set_function("new",static_cast<cocostudio::MovementData*(*)()>(&cocostudio::MovementData::create));
}
...
mt.set_function("new",static_cast<cocostudio::AnimationData*(*)()>(&cocostudio::AnimationData::create));
}
...
mt.set_function("new",static_cast<cocostudio::ContourData*(*)()>(&cocostudio::ContourData::create));
}
