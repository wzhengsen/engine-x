...
void lua_register_cocos2dx_spine_SkeletonRenderer(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<spine::SkeletonRenderer,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject,cocos2d::BlendProtocol>(lua.get_or("sp",lua.create_named_table("sp")),"SkeletonRenderer");
...
mt["setSkin"]=static_cast<void(spine::SkeletonRenderer::*)(const char*)>(&spine::SkeletonRenderer::setSkin),static_cast<void(spine::SkeletonRenderer::*)(const std::string&)>(&spine::SkeletonRenderer::setSkin);
...
mt["create"]=static_cast<spine::SkeletonRenderer*(*)()>(&spine::SkeletonRenderer::create);
...
void lua_register_cocos2dx_spine_SkeletonAnimation(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<spine::SkeletonAnimation,spine::SkeletonRenderer,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject,cocos2d::BlendProtocol>(lua.get_or("sp",lua.create_named_table("sp")),"SkeletonAnimation");
...
mt["create"]=static_cast<spine::SkeletonAnimation*(*)()>(&spine::SkeletonAnimation::create);
...
void register_all_cocos2dx_spine(cocos2d::Lua& lua) {
	lua_register_cocos2dx_spine_SkeletonRenderer(lua);
	lua_register_cocos2dx_spine_SkeletonAnimation(lua);
}
