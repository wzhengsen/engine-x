...
void lua_register_cocos2dx_3d_Animation3D(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Animation3D,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Animation3D");
...
mt["create"]=sol::overload([](cocos2d::Animation3D* obj,const std::string& arg0){return obj->create(arg0);},[](cocos2d::Animation3D* obj,const std::string& arg0,const std::string& arg1){return obj->create(arg0,arg1);});
}
void lua_register_cocos2dx_3d_Animate3D(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Animate3D,cocos2d::ActionInterval,cocos2d::FiniteTimeAction,cocos2d::Action,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Animate3D");
...
mt["init"]=static_cast<bool(cocos2d::Animate3D::*)(cocos2d::Animation3D*,float,float)>(&cocos2d::Animate3D::init),static_cast<bool(cocos2d::Animate3D::*)(cocos2d::Animation3D*)>(&cocos2d::Animate3D::init);
mt["initWithFrames"]=static_cast<bool(cocos2d::Animate3D::*)(cocos2d::Animation3D*,int,int,float)>(&cocos2d::Animate3D::initWithFrames);
mt["create"]=static_cast<cocos2d::Animate3D*(*)(cocos2d::Animation3D*,float,float)>(&cocos2d::Animate3D::create),static_cast<cocos2d::Animate3D*(*)(cocos2d::Animation3D*)>(&cocos2d::Animate3D::create);
...
void lua_register_cocos2dx_3d_TextureCube(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::TextureCube,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"TextureCube");
...
mt["create"]=static_cast<cocos2d::TextureCube*(*)(const std::string&,const std::string&,const std::string&,const std::string&,const std::string&,const std::string&)>(&cocos2d::TextureCube::create);
}
void lua_register_cocos2dx_3d_AttachNode(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::AttachNode,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"AttachNode");
...
mt["create"]=static_cast<cocos2d::AttachNode*(*)(cocos2d::Bone3D*)>(&cocos2d::AttachNode::create);
}
void lua_register_cocos2dx_3d_BillBoard(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::BillBoard,cocos2d::Sprite,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject,cocos2d::TextureProtocol,cocos2d::BlendProtocol>(lua.get_or("cc",lua.create_named_table("cc")),"BillBoard");
...
void lua_register_cocos2dx_3d_Mesh(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Mesh,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Mesh");
...
void lua_register_cocos2dx_3d_Skeleton3D(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Skeleton3D,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Skeleton3D");
...
void lua_register_cocos2dx_3d_Skybox(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Skybox,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Skybox");
...
mt["init"]=static_cast<bool(cocos2d::Skybox::*)(const std::string&,const std::string&,const std::string&,const std::string&,const std::string&,const std::string&)>(&cocos2d::Skybox::init),static_cast<bool(cocos2d::Skybox::*)()>(&cocos2d::Skybox::init);
mt["create"]=static_cast<cocos2d::Skybox*(*)(const std::string&,const std::string&,const std::string&,const std::string&,const std::string&,const std::string&)>(&cocos2d::Skybox::create),static_cast<cocos2d::Skybox*(*)()>(&cocos2d::Skybox::create);
}
void lua_register_cocos2dx_3d_Sprite3D(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Sprite3D,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject,cocos2d::BlendProtocol>(lua.get_or("cc",lua.create_named_table("cc")),"Sprite3D");
mt["setTexture"]=static_cast<void(cocos2d::Sprite3D::*)(cocos2d::Texture2D*)>(&cocos2d::Sprite3D::setTexture),static_cast<void(cocos2d::Sprite3D::*)(const std::string&)>(&cocos2d::Sprite3D::setTexture);
...
mt["setMaterial"]=static_cast<void(cocos2d::Sprite3D::*)(cocos2d::Material*,int)>(&cocos2d::Sprite3D::setMaterial),static_cast<void(cocos2d::Sprite3D::*)(cocos2d::Material*)>(&cocos2d::Sprite3D::setMaterial);
...
mt["create"]=static_cast<cocos2d::Sprite3D*(*)(const std::string&)>(&cocos2d::Sprite3D::create),static_cast<cocos2d::Sprite3D*(*)()>(&cocos2d::Sprite3D::create),static_cast<cocos2d::Sprite3D*(*)(const std::string&,const std::string&)>(&cocos2d::Sprite3D::create);
}
void lua_register_cocos2dx_3d_Sprite3DCache(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Sprite3DCache>(lua.get_or("cc",lua.create_named_table("cc")),"Sprite3DCache");
...
void lua_register_cocos2dx_3d_Sprite3DMaterial(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Sprite3DMaterial,cocos2d::Material,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Sprite3DMaterial");
...
mt["createBuiltInMaterial"]=static_cast<void(*)()>(&cocos2d::Sprite3DMaterial::createBuiltInMaterial),static_cast<cocos2d::Sprite3DMaterial*(*)(cocos2d::Sprite3DMaterial::MaterialType,bool)>(&cocos2d::Sprite3DMaterial::createBuiltInMaterial);
...
void lua_register_cocos2dx_3d_Terrain(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Terrain,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>(lua.get_or("cc",lua.create_named_table("cc")),"Terrain");
...
void lua_register_cocos2dx_3d_Bundle3D(cocos2d::Lua& lua){
auto mt=cocos2d::Lua::NewUserType<cocos2d::Bundle3D>(lua.get_or("cc",lua.create_named_table("cc")),"Bundle3D");
...
void register_all_cocos2dx_3d(cocos2d::Lua& lua) {
	lua_register_cocos2dx_3d_Animation3D(lua);
	lua_register_cocos2dx_3d_Animate3D(lua);
	lua_register_cocos2dx_3d_TextureCube(lua);
	lua_register_cocos2dx_3d_AttachNode(lua);
	lua_register_cocos2dx_3d_BillBoard(lua);
	lua_register_cocos2dx_3d_Mesh(lua);
	lua_register_cocos2dx_3d_Skeleton3D(lua);
	lua_register_cocos2dx_3d_Skybox(lua);
	lua_register_cocos2dx_3d_Sprite3D(lua);
	lua_register_cocos2dx_3d_Sprite3DCache(lua);
	lua_register_cocos2dx_3d_Sprite3DMaterial(lua);
	lua_register_cocos2dx_3d_Terrain(lua);
	lua_register_cocos2dx_3d_Bundle3D(lua);
}
