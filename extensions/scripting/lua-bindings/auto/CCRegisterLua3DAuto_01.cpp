...
void RegisterLua3DAnonymousEnum__6134653066911589495_Auto(cocos2d::Lua& lua) {
sol::table pTable = lua["cc"];
pTable["TMXStaggerAxis_X"] = 0;
pTable["TMXStaggerAxis_Y"] = 1;
}
void RegisterLua3DAnonymousEnum__7541095390690929856_Auto(cocos2d::Lua& lua) {
sol::table pTable = lua["cc"];
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::AttachNode,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("AttachNode",false);
ns["AttachNode"] = mt;
lua["AttachNode"] = sol::nil;
...
void RegisterLua3DBillBoardModeAuto(cocos2d::Lua& lua) {
sol::table pTable = lua["cc"];
pTable = pTable["BillBoard"];
...
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::BillBoard,cocos2d::Sprite,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject,cocos2d::TextureProtocol,cocos2d::BlendProtocol>("BillBoard",false);
ns["BillBoard"] = mt;
lua["BillBoard"] = sol::nil;
...
RegisterLua3DBillBoardModeAuto(lua);
}
void RegisterLua3DMeshAuto(cocos2d::Lua& lua){
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::Mesh,cocos2d::Ref,cocos2d::LuaObject>("Mesh",false);
ns["Mesh"] = mt;
lua["Mesh"] = sol::nil;
...
mt.set_function(sol::meta_function::construct,static_cast<cocos2d::Skeleton3D*(*)(const std::vector<cocos2d::NodeData *>&)>(&cocos2d::Skeleton3D::create));
}
void RegisterLua3DSkyboxAuto(cocos2d::Lua& lua){
sol::table ns = lua["cc"];
auto mt=lua.NewUserType<cocos2d::Skybox,cocos2d::Node,cocos2d::Ref,cocos2d::LuaObject>("Skybox",false);
ns["Skybox"] = mt;
lua["Skybox"] = sol::nil;
...
void RegisterLua3DSprite3DMaterialMaterialTypeAuto(cocos2d::Lua& lua) {
sol::table pTable = lua["cc"];
...
RegisterLua3DSprite3DMaterialMaterialTypeAuto(lua);
}
