...
#include "cocos-ext.h"
static void RegisterLuaExtensionEventAssetsManagerEx(cocos2d::Lua& lua){
...
static void RegisterLuaExtensionManifest(cocos2d::Lua& lua){
...
static void RegisterLuaExtensionAssetsManagerEx(cocos2d::Lua& lua){
...
mt["new"]=sol::overload([](cocos2d::extension::AssetsManagerEx* obj,const std::string& arg0,const std::string& arg1){return obj->create(arg0,arg1);},[](cocos2d::extension::AssetsManagerEx* obj,const std::string& arg0,const std::string& arg1,uint32_t arg2){return obj->create(arg0,arg1,arg2);});
}
static void RegisterLuaExtensionEventListenerAssetsManagerEx(cocos2d::Lua& lua){
...
static void RegisterLuaExtensionParticleSystem3D(cocos2d::Lua& lua){
...
static void RegisterLuaExtensionPUParticleSystem3D(cocos2d::Lua& lua){
...
mt["new"]=sol::overload(static_cast<cocos2d::PUParticleSystem3D*(*)(const std::string&)>(&cocos2d::PUParticleSystem3D::create),static_cast<cocos2d::PUParticleSystem3D*(*)()>(&cocos2d::PUParticleSystem3D::create),static_cast<cocos2d::PUParticleSystem3D*(*)(const std::string&,const std::string&)>(&cocos2d::PUParticleSystem3D::create));
}
void RegisterLuaExtensionAuto(cocos2d::Lua& lua) {
RegisterLuaExtensionEventAssetsManagerEx(lua);
RegisterLuaExtensionManifest(lua);
RegisterLuaExtensionAssetsManagerEx(lua);
RegisterLuaExtensionEventListenerAssetsManagerEx(lua);
RegisterLuaExtensionParticleSystem3D(lua);
RegisterLuaExtensionPUParticleSystem3D(lua);
}
