...
gl.VERTEX_ATTRIB_FLAG_NONE = 0;
gl.VERTEX_ATTRIB_FLAG_POSITION = 1 << 0;
gl.VERTEX_ATTRIB_FLAG_COLOR = 1 << 1;
gl.VERTEX_ATTRIB_FLAG_TEX_COORD = 1 << 2;
gl.VERTEX_ATTRIB_FLAG_NORMAL = 1 << 3;
gl.VERTEX_ATTRIB_FLAG_BLEND_WEIGHT = 1 << 4;
gl.VERTEX_ATTRIB_FLAG_BLEND_INDEX = 1 << 5;
gl.VERTEX_ATTRIB_FLAG_POS_COLOR_TEX = 1 | 2 | 4;
