...
class Ui_ModuleMgrDlg(object):
    def setupUi(self, ModuleMgrDlg):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.InfoTableWidget.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.ModuleInfoTabWidget.setCurrentIndex(1)
    ...
    def retranslateUi(self, ModuleMgrDlg):
        ...
        item.setText(_translate("ModuleMgrDlg", "packageUrl"))
        ...
        item = self.InfoTableWidget.verticalHeaderItem(4)
        item.setText(_translate("ModuleMgrDlg", "allZipFileName"))
        item.setToolTip(_translate("ModuleMgrDlg", "整包热更zip文件名"))
